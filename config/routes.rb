...
Rails.application.routes.draw do
  ...
  get  "/new_web_development_form"                      => "form#new_web_development_form",                               as: "new_web_development_form"
  ...
  get "/apply_web_development_award"                    => "content_only#apply_web_development_award",                    as: "apply_web_development_award"
  get "/award_info_web"                                 => "content_only#award_info_web",                                 as: "award_info_web"
